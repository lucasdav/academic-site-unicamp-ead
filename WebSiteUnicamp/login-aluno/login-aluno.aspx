<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login-aluno.aspx.cs" Inherits="login_aluno" %>
	...
	<div class="container-fluid" style="padding: 0px !important; margin-bottom: 0px !important; padding-bottom: 0px !important;">
		<div class="row div-header">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a id="linkPortalProfessor" runat="server" onserverclick="direcionarPortalProfessor" class="nav-link" style="font-weight:bold; margin-right:20px;">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#" style="font-weight:bold; margin-right:20px;">
						...
						Portal do Aluno<span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </nav>
		...
		<div class="row" style="display: flex;margin-left: 0px !important; margin-right: 0px !important">
			<div class="col-md-6 col-xs-12 col-sm-6" style="max-width:400px; margin:50px;">
				...
				<div id="id_alerta_campo_vazio" runat="server" visible="false" class="alert alert-danger" role="alert">
		...
		<footer class="page-footer font-small blue pt-4 mt-4" style="background: #070707; margin-top: 17% !important;">            
