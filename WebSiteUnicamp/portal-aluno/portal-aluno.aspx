<%@ Page Language="C#" AutoEventWireup="true" CodeFile="portal-aluno.aspx.cs" Inherits="portal_aluno" %>
	...
	<div class="container-fluid" style="padding-left:0px !important; padding-right:0px; margin-bottom: 0px !important; padding-bottom: 0px !important; padding-left:0; padding-right:0;">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <ul class="navbar-nav" style="width: 90%;">
                ...
                <li class="nav-item" runat="server" id="linkChatProf" visible="false">
                    <a class="nav-link" runat="server" id="linkChatProfessor" onserverclick="direcionaChatProf"  style="font-weight:bold; margin-right:20px;">
						<img style="width:20px; height:20px; margin-right: 10px;" src="../icons/svg/si-glyph-congratulation-hat.svg"/>
						Chat com Professor</a>					
                </li>
            </ul>
		...
		<div class="row" style="display: flex;margin-left: 0px !important; margin-right: 0px !important; padding-bottom:160px">
			...
			<div class="col-md-7" id="carregarChat" runat="server" visible="false" style="max-height: max-content; background-color: gainsboro; padding-top: 20px; 
				    border-bottom-left-radius: 10px; padding-bottom: 60px;">
				<asp:Panel ID="pnlChat" runat="server"></asp:Panel>
				
                <div style="display: -webkit-inline-box;">
					<asp:DataList ID="DataList1" style="border-radius: 5px; padding: 20px; margin: 20px; background-color: ghostwhite;" runat="server" RepeatDirection="Vertical">
						<ItemTemplate>
                    ...
                    <div style="position:relative; top: 20px;">
						...
						<textarea id="txtMensagem" runat="server" rows="4" cols="60" name="comment" style="resize:none; border-radius:5px; display: -webkit-box;" 
                            placeholder="Insira a mensagem aqui..."></textarea>
						<button id="btnEnviarMensagem" style="margin-top: -41px; float:right; font-weight:bold" class="btn btn-info" runat="server" onserverclick="btnEnviarMensagem_Click">
                            Enviar
